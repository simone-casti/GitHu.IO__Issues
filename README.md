...
To close an issue in another repository, use the <dfn>username/repository#issue_number syntax</dfn>, as described in "Writing on GitHub".

For example, including <dfn>Closes example_user/example_repo#76</dfn> will close the referenced issue in that repository, provided you have push access to that repository.
</body>
</html>
